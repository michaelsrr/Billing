...
while True:
    ret, frame = cap.read()
    if ret == False:break
    cv2.putText(frame, 'Ubique aquí el texto a leer', (158, 80), cv2.FONT_HERSHEY_SIMPLEX, 8.71, (255, 255, 0),2)
    cv2.putText(frame, 'Ubique aquí el texto a leer', (160, 80), cv2.FONT_HERSHEY_SIMPLEX, 8.7, (0, 0, 0),2)
